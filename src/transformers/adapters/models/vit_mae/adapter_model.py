...
from ....models.vit_mae.modeling_vit_mae import VIT_MAE_INPUTS_DOCSTRING, VIT_MAE_START_DOCSTRING, ViTMAEModel, ViTMAEPreTrainedModel
...
@add_start_docstrings(
    """ViTMAE Model transformer with the option to add multiple flexible heads on top.""",
    VIT_MAE_START_DOCSTRING,
)
class ViTMAEAdapterModel(ModelWithFlexibleHeadsAdaptersMixin, ViTMAEPreTrainedModel):
