...
from ...adapters.mixins.vit_mae import ViTMAELayerAdaptersMixin, ViTMAEModelAdaptersMixin, ViTMAEOutputAdaptersMixin
...
class ViTMAESelfAttention(nn.Module):
    def __init__(self, config: ViTMAEConfig, location_key: Optional[str] = None) -> None:
        super().__init__()
...
class ViTMAEOutput(ViTMAEOutputAdaptersMixin, nn.Module):
    def __init__(self, config: ViTMAEConfig) -> None:
        super().__init__()
        self.config = config
...
class ViTMAELayer(ViTMAELayerAdaptersMixin, nn.Module):
...
class ViTMAEModel(ViTMAEModelAdaptersMixin, ViTMAEPreTrainedModel):
    def __init__(self, config):
...
class ViTMAEForPreTraining(ModelWithHeadsAdaptersMixin, ViTMAEPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.config = config
